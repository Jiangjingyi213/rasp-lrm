...
- `runs/eval_dense_qwen3_gsm8k_budget`
- `runs/eval_dense_qwen3_math500_budget`

这两个目录的结果与 motivation 实验中分片跑出的 dense 结果一致：

- `runs/formal_qwen3_gsm8k_full_s0` + `runs/formal_qwen3_gsm8k_full_s1`
- `runs/formal_qwen3_math500_full_s0` + `runs/formal_qwen3_math500_full_s1`
...
- `runs/eval_griffin_p20_qwen3_gsm8k_budget`
- `runs/eval_griffin_p20_qwen3_math500_budget`
- `runs/eval_griffin_p40_qwen3_gsm8k_budget`
- `runs/eval_griffin_p40_qwen3_math500_budget`
- `runs/eval_griffin_p60_qwen3_gsm8k_budget`
- `runs/eval_griffin_p60_qwen3_math500_budget`
...
- `runs/flap_mlp_formal/eval_flap_mlp_wifn_ulum_wikitext2_nobias_p05_qwen3_gsm8k_budget`
- `runs/flap_mlp_formal/eval_flap_mlp_wifn_ulum_wikitext2_nobias_p05_qwen3_math500_budget`
- `runs/flap_mlp_formal/eval_flap_mlp_wifn_ulum_wikitext2_nobias_p20_qwen3_gsm8k_budget`
- `runs/flap_mlp_formal/eval_flap_mlp_wifn_ulum_wikitext2_nobias_p20_qwen3_math500_budget`
- `runs/flap_mlp_formal/eval_flap_mlp_wifn_ulum_wikitext2_nobias_p40_qwen3_gsm8k_budget`
- `runs/flap_mlp_formal/eval_flap_mlp_wifn_ulum_wikitext2_nobias_p40_qwen3_math500_budget`
- `runs/flap_mlp_formal/eval_flap_mlp_wifn_ulum_wikitext2_nobias_p60_qwen3_gsm8k_budget`
- `runs/flap_mlp_formal/eval_flap_mlp_wifn_ulum_wikitext2_nobias_p60_qwen3_math500_budget`
