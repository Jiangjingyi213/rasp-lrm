...
export CONFIG="${CONFIG:-configs/stage_calibrated_pruning/flap_mlp_qwen3_1p7b_priority_suite.yaml}"
export RUN_ROOT="${RUN_ROOT:-runs/08_stage_calibrated_pruning/main_pilot_flap_mlp_qwen3_1p7b_priority_suite}"
export STAGE_FINAL_METHODS="${STAGE_FINAL_METHODS:-flap_mlp_t30_official}"
export LOG_PREFIX="${LOG_PREFIX:-flap_mlp_qwen3_1p7b_priority}"
...
export SOURCE_ROOT
export BASELINE_LABEL="${BASELINE_LABEL:-FLAP-MLP Qwen3}"
export BASELINE_SCHEMA="${BASELINE_SCHEMA:-flap_mlp_qwen3_priority_suite_aggregate_v1}"
