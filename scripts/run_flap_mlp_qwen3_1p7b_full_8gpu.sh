...
export CONFIG="${CONFIG:-configs/stage_calibrated_pruning/flap_mlp_qwen3_1p7b_full.yaml}"
export RUN_ROOT="${RUN_ROOT:-runs/08_stage_calibrated_pruning/main_pilot_flap_mlp_qwen3_1p7b_full}"
export STAGE_FINAL_METHODS="${STAGE_FINAL_METHODS:-flap_mlp_t30_official}"
export RUN_LABEL="${RUN_LABEL:-flap_mlp_qwen3_1p7b_full}"
...
export BASELINE_SCHEMA="${BASELINE_SCHEMA:-flap_mlp_qwen3_full_v1}"
