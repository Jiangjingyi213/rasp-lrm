...
export CONFIG="${CONFIG:-configs/stage_calibrated_pruning/shortgpt_qwen3_1p7b_full.yaml}"
export RUN_ROOT="${RUN_ROOT:-runs/08_stage_calibrated_pruning/main_pilot_shortgpt_qwen3_1p7b_full}"
