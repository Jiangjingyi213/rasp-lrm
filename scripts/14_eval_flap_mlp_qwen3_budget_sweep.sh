...
TAGS="${TAGS:-flap_mlp_p05 flap_mlp_p20 flap_mlp_p40 flap_mlp_p60}"
RUN_ROOT="${RUN_ROOT:-runs/02_baselines/flap_mlp_formal}"
...
FLAP_BIAS_COMPENSATION="${FLAP_BIAS_COMPENSATION:-false}"
